    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/classes/{classId}/dashboard").authenticated() // 강의 대시보드 정보 불러오기
                        .requestMatchers(HttpMethod.PATCH, "/api/classes/{classId}/dashboard/students").authenticated() // 강의를 듣는 수강생 리스트 정보 불러오기, 강사만 가능
